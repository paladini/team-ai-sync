# Tasks: Generalized Sync Action

- [x] T001: Scaffold action project, examples, CI, and TLC docs.
- [x] T002: Implement config validation and path safety.
- [x] T003: Implement file sync engine.
